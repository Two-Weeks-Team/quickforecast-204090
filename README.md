...
Professionals waste hours entering and categorizing their monthly income and expenses, then feel stuck watching no progress on savings or goals.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/quickforecast
      branch: master
